...
2. Clone the Repository: Clone your forked repository to your local machine using the following command:
   ...
   ```bash
   git clone https://github.com/Kavipriya2926portfolio-nextjs.git
   ```
...
If you encounter any issues or bugs while using the Portfolio Website, please report them on the [Issues](https://https://github.com/Kavipriya2926/portfolio-nextjs/issues) page of the repository. Provide as much detail as possible to help us understand and address the problem.
